                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            ...
                            <li><a href="/showCart"><i class="fa fa-shopping-bag"></i> <span>{{Cart::name('shoppingCart')->getDetails()->get('items_count')}}</span></a></li>
                        </ul>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="/products/{{$product->slog}}">{{$product->name}}</a></h6>
